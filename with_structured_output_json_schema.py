...
# schema
schema = {
    "title": "Review of a Motorola Edge 50 Fusion smartphone",
    "type": "object",
    "properties": {
        "summary": {"type": "string"},
        "List of specifications": {"type": "array", "items": {"type": "string"}},
        "sentiment": {"type": "string", "enum": ["positive", "negative", "neutral"]},
        "cost": {"type": ["string", "null"], "description": "The cost of the product in USD, if available"}
    },
    "required": ["summary", "List of specifications", "sentiment"]
}

structure = chat.with_structured_output(schema)
